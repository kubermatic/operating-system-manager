...
// ValidateCloudProvider validates if the cloud provider is supported or not.
// It returns an error in case of an unsupported cloud provider.
func ValidateCloudProvider(pconfig providerconfig.Config) error {
