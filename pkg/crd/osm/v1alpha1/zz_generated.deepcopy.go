...
func (in *OperatingSystemProfileSpec) DeepCopyInto(out *OperatingSystemProfileSpec) {
	*out = *in
	if in.SupportedCloudProviders != nil {
		...
		*out = make([]SupportedCloudProvider, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SupportedCloudProvider) DeepCopyInto(out *SupportedCloudProvider) {
	*out = *in
	in.Spec.DeepCopyInto(&out.Spec)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SupportedCloudProvider.
func (in *SupportedCloudProvider) DeepCopy() *SupportedCloudProvider {
	if in == nil {
		return nil
	}
	out := new(SupportedCloudProvider)
	in.DeepCopyInto(out)
	return out
}
